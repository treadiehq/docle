  ...
  <div class="relative min-h-screen flex-1 flex flex-col bg-surface text-zinc-100">
    ...
    <div class="relative flex flex-1 flex-col w-full">
      ...
      <nav class="mx-auto flex max-w-3xl items-center justify-between px-6 py-4 w-full">
        <span class="ttext-base font-semibold text-white">Docle</span>

        <a href="https://discord.gg/KqdBcqRk5E" target="_blank" rel="noopener" class="transition text-muted hover:text-white"">
        ...
        <!-- <a href="#" class="transition text-muted hover:text-white " aria-label="GitHub">
